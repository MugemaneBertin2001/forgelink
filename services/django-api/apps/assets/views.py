...
from .serializers import (
    PlantSerializer, PlantMinimalSerializer,
    AreaSerializer, AreaMinimalSerializer,
    LineSerializer, LineMinimalSerializer,
    CellSerializer, CellMinimalSerializer,
    DeviceTypeSerializer, DeviceTypeMinimalSerializer,
    DeviceSerializer, DeviceMinimalSerializer, DeviceCreateSerializer,
    DeviceStatusSerializer, DeviceThresholdsSerializer,
    MaintenanceRecordSerializer, MaintenanceRecordCreateSerializer,
    HierarchySerializer, DeviceSearchSerializer,
)
...
class PlantViewSet(viewsets.ModelViewSet):
    ...
    def devices(self, request, code=None):
        ...
        devices = Device.objects.filter(
            cell__line__area__plant=plant
        ).select_related('device_type', 'cell__line__area')
...
class AreaViewSet(viewsets.ModelViewSet):
    ...
    def devices(self, request, pk=None):
        ...
        devices = Device.objects.filter(
            cell__line__area=area
        ).select_related('device_type', 'cell__line')
    ...
    def status_summary(self, request, pk=None):
        ...
        return Response({
            ...
            'by_type': {item['device_type__code']: item['count'] for item in by_type},
        })
...
class DeviceViewSet(viewsets.ModelViewSet):
    ...
    def maintenance(self, request, device_id=None):
        ...
        if request.method == 'GET':
            ...
            serializer = MaintenanceRecordCreateSerializer(data={
                **request.data,
                'device': device.id
            })
            serializer.is_valid(raise_exception=True)
    ...
    def status_summary(self, request):
        ...
        return Response({
            ...
            'by_type': {item['device_type__code']: item['count'] for item in by_type},
            'by_area': {item['cell__line__area__code']: item['count'] for item in by_area},
        })
