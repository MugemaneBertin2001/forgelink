...
class PlantAdmin(ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Location", {"fields": ("timezone", "latitude", "longitude", "address")}),
        ("Status", {"fields": ("is_active", "commissioned_at")}),
        (
            "Metadata",
...
class AreaAdmin(ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("plant", "code", "name", "description")}),
        ("Configuration", {"fields": ("area_type", "sequence")}),
...
class LineAdmin(ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("area", "code", "name", "description")}),
        ("Capacity", {"fields": ("design_capacity", "capacity_unit")}),
        ("Status", {"fields": ("is_active",)}),
        (
            "Metadata",
            {"fields": ("id", "created_at", "updated_at"), "classes": ("collapse",)},
...
class CellAdmin(ModelAdmin):
    list_display = ["code", "name", "line", "is_active_badge", "device_count"]
    ...
    fieldsets = (
        (None, {"fields": ("line", "code", "name", "description")}),
        ("Status", {"fields": ("is_active",)}),
        (
            "Metadata",
            {"fields": ("id", "created_at", "updated_at"), "classes": ("collapse",)},
...
class DeviceTypeAdmin(ModelAdmin):
    list_display = ["code", "name", "default_unit", "typical_range", "device_count"]
    search_fields = ["code", "name", "description"]
    readonly_fields = ["id", "created_at", "updated_at"]

    fieldsets = (
        (None, {"fields": ("code", "name", "description", "icon")}),
        ("Measurement", {"fields": ("default_unit", "typical_min", "typical_max")}),
        (
            "Metadata",
            {"fields": ("id", "created_at", "updated_at"), "classes": ("collapse",)},
        ),
...
class DeviceAdmin(ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("device_id", "name", "description", "cell", "device_type")}),
        ("Device Details", {"fields": ("manufacturer", "model", "serial_number")}),
        ("Measurement", {"fields": ("unit", "precision", "sampling_rate_ms")}),
        (
            "Thresholds",
            {
                "fields": (
        ...
        ("Tags", {"fields": ("tags",)}),
        ("Paths", {"fields": ("full_path", "uns_topic"), "classes": ("collapse",)}),
        (
            "Metadata",
            {"fields": ("id", "created_at", "updated_at"), "classes": ("collapse",)},
        ),
...
class MaintenanceRecordAdmin(ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("device", "maintenance_type")}),
        (
            "Details",
            {
                "fields": (
        ...
        ("Parts & Cost", {"fields": ("parts_used", "cost")}),
        ("Scheduling", {"fields": ("next_scheduled",)}),
