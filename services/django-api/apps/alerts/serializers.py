...
class AlertRuleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'name', 'description',
            'device', 'device_id', 'device_type', 'device_type_code', 'area_code',
            'rule_type', 'threshold_value', 'threshold_low', 'threshold_high',
            'rate_threshold', 'stale_minutes',
            'severity', 'notify_slack', 'slack_channel', 'cooldown_minutes',
...
class AlertSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Alert
        fields = [
            'id', 'rule', 'device', 'device_id', 'device_name', 'area',
            'alert_type', 'severity', 'message',
            'value', 'threshold', 'unit',
            'status', 'triggered_at',
            'acknowledged_at', 'acknowledged_by',
            'resolved_at', 'resolved_by',
            'notified_slack', 'notified_at',
            'duration_seconds'
        ]
        read_only_fields = [
            'id', 'rule', 'device', 'alert_type', 'severity', 'message',
            'value', 'threshold', 'unit', 'triggered_at',
            'notified_slack', 'notified_at', 'duration_seconds'
        ]
