...
from apps.simulator.models import DeviceProfile, SimulatedDevice, SimulatedPLC
...
class Command(BaseCommand):
    ...
    def create_melt_shop(self, profiles: dict):
        ...
        self.stdout.write(
            f"  Created Melt Shop: {eaf1_plc.devices.count() + offgas_plc.devices.count() + lrf1_plc.devices.count()} devices"
        )
    ...
    def create_continuous_casting(self, profiles: dict):
        ...
        self.stdout.write("  Created Continuous Casting: 16 devices")
    ...
    def create_rolling_mill(self, profiles: dict):
        ...
        self.stdout.write("  Created Rolling Mill: 24 devices")
    ...
    def create_finishing(self, profiles: dict):
        ...
        self.stdout.write("  Created Finishing: 5 devices")
